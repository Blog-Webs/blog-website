  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex flex-col items-end gap-2 text-sm font-medium" style={{ color: 'var(--text-muted)' }}>
          {topic.category && (
            <div className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-md bg-black/5 dark:bg-white/5 text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary transition-colors">
              {topic.category.name}
            </div>
          )}
